...
import { surveyReducer } from '../components/survey/store/survey.reducer';
import { profileReducer } from '../components/profile/store/profile.reducer';
import { allUsersReducer, correctionReducer } from '../components/action-corrective/store/correction.reducer';
